...
from datatrove.io import LocalInputDataFolder, S3OutputDataFolder, LocalOutputDataFolder, S3InputDataFolder
...
#
pipeline = [
    JsonlReader(S3InputDataFolder(path="s3://refinedweb-tests/test-s3-output2")),
    JsonlWriter(S3OutputDataFolder(path="s3://refinedweb-tests/test-s3-output4"))
]
