    ...
    def close(self, rank: int = 0):
        ...
        while True:
            try:
                ...
                if "A commit has happened since" in e.server_message or "maximum queue size reached" in e.server_message or "maximum time in concurrency queue reached" in e.server_message:
