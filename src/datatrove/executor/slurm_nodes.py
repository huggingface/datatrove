...
class SlurmPipelineNodeExecutor(PipelineExecutor):
    ...
    def __init__(
        ...
        depends: SlurmPipelineNodeExecutor | None = None,
        ...
        self.tasks_per_node = cpus_per_node // cpus_per_task
    ...
    def launch_job(self):
        ...
        assert not self.depends or (
            isinstance(self.depends, SlurmPipelineNodeExecutor)
        ...
        nb_jobs_to_launch = math.ceil(
            len(ranks_to_run) / self.tasks_per_job / self.tasks_per_node
        )  # total nb of nodes we need
