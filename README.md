...
### Summary Statistics
For summary statistics on your data you can use the [Stats](https://github.com/huggingface/datatrove/tree/summary_stats/src/datatrove/pipeline/stats) blocks. These blocks provide an easy way to collect data-profiles on your dataset in a distributed manner. It's a two step process in which you first:
