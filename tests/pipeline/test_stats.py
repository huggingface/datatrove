...
class TestStatsModules(unittest.TestCase):
    ...
    def test_line_stats(self):
        docs = [
            Document("hello\nhow\nare \nyou?", "1", metadata={"url": "test.cz"}),
            Document("test test a", "2", metadata={"url": "test.cz"}),
        ]

        expected_line_stats = {
            "n_lines": {"4": 1, "1": 1},
            "avg_line_length": {"4.0": 1, "11.0": 1},
            "short_line_ratio_chars_3": {"0.25": 1, "0.0": 1},
            "long_line_ratio_chars_5": {"0.25": 1, "1.0": 1},
        }
    ...
    def test_doc_stats(self):
        ...
        expected_doc_stats = {
            "length": {"2": 1, "5": 1},
            "white_space_ratio": {"0.2": 1, "0.0": 1},
            "non_alpha_digit_ratio": {"0.5": 1, "0.2": 1},
    ...
    def test_word_stats(self):
        ...
        expected_word_stats = {
            "n_words": {"2": 1, "3": 1, "1": 1},
            "avg_word_length": {"3.0": 1, "4.0": 1, "12.0": 1},
